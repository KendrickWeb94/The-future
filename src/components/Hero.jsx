                ...
                <div className="tw-container">
                    <div className="w-full flex lg:flex-nowrap flex-wrap justify-between gap-10">
                        <div className="space-y-7 md:max-w-2xl">
                            <h1 ref={headingRef} className="md:text-6xl ds:text-4xl font-inter text-balance font-bold md:leading-[4.5rem] text-heading_text">
                                Everything you need in one place
                            </h1>
                            <p ref={paragraphRef} className="font-inter font-semibold text-sm text-balance leading-7 text-text_light">
